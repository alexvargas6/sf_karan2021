...
/* Wizard-3.html.twig */
class __TwigTemplate_e77a89734afdc16081dd25ed72289a5385fe5cd379591f33a98b657f8f4d2ed8 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 42
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["wizard"], "method", false, false, false, 42), "html", null, true);
        echo "
                    <a href=\"";
        // line 43
        ...
        echo "\" class=\"btn btn-sm btn-outline-secondary\"
                       title=\"";
        // line 44
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["refresh"], "method", false, false, false, 44), "html", null, true);
        echo "\">
                ...
                <p>";
        // line 48
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["wizard-p"], "method", false, false, false, 48), "html", null, true);
        echo "</p>
                <hr/>
...
";
    ...
    {
        return new Source("", "Wizard-3.html.twig", "C:\\xampp\\htdocs\\facturascripts\\Dinamic\\View\\Wizard-3.html.twig");
    }
}
