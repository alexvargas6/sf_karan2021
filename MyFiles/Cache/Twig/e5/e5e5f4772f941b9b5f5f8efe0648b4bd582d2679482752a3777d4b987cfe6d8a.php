...
class __TwigTemplate_a0fc89503ff92aaff9f491b2105a5c819449d98896691ce76fa352e21a2507f3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
                            ...
                            <div class=\"form-row\">
                                <div class=\"col-sm-3\">
                                    <div class=\"form-group\">
                                        ";
        // line 42
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["company"], "method", false, false, false, 42), "html", null, true);
        echo "
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["empresa"]) {
            // line 45
            echo "                                                ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["empresa"], "idempresa", [], "any", false, false, false, 45), twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "idempresa", [], "any", false, false, false, 45)))) {
                // line 46
                echo "                                                    <option value=\"";
        ...
        echo "                                        </select>
                                ...
                                <div class=\"col-sm-3\">
                                    <div class=\"form-group\">
                                        ";
        // line 57
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["invoices"], "method", false, false, false, 57), "html", null, true);
        echo "
                                        <select name=\"source\" class=\"form-control\">
                                            ";
        // line 59
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "source", [], "any", false, false, false, 59), "purchases"))) {
            // line 60
            echo "                                                <option value=\"sales\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["sales"], "method", false, false, false, 60), "html", null, true);
            echo "</option>
                                                <option value=\"purchases\"
                                                        selected=\"\">";
            // line 62
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["purchases"], "method", false, false, false, 62), "html", null, true);
            echo "</option>
                                            ";
        } else {
            // line 64
            echo "                                                <option value=\"sales\" selected=\"\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["sales"], "method", false, false, false, 64), "html", null, true);
            echo "</option>
                                                <option value=\"purchases\">";
            // line 65
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["purchases"], "method", false, false, false, 65), "html", null, true);
            echo "</option>
                                            ";
        }
        // line 67
        echo "                                        </select>
                                ...
                                <div class=\"col-sm-3\">
                                    <div class=\"form-group\">
                                        ";
        // line 72
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["from-date"], "method", false, false, false, 72), "html", null, true);
        echo "
        ...
        echo "\"
                                ...
                                <div class=\"col-sm-3\">
                                    <div class=\"form-group\">
                                        ";
        // line 79
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["until-date"], "method", false, false, false, 79), "html", null, true);
        echo "
                            ...
                            <div class=\"form-row align-items-end\">
                                <div class=\"col-sm-3\">
                                    <div class=\"form-group\">
                                        ";
        // line 88
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["serie"], "method", false, false, false, 88), "html", null, true);
        echo "
                                        <select name=\"codserie\" class=\"form-control\">
                                            <option value=\"\">";
        // line 90
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["all"], "method", false, false, false, 90), "html", null, true);
        echo "</option>
                                            <option value=\"\">------</option>
                                            ";
        // line 92
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "serie", [], "any", false, false, false, 92), "all", [[], ["descripcion" => "ASC"], 0, 0], "method", false, false, false, 92));
        foreach ($context['_seq'] as $context["_key"] => $context["serie"]) {
            // line 93
            echo "                                                ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["serie"], "codserie", [], "any", false, false, false, 93), twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "codserie", [], "any", false, false, false, 93)))) {
                // line 94
                echo "                                                    <option value=\"";
        ...
        echo "                                        </select>
                                ...
                                <div class=\"col-sm-3\">
                                    <div class=\"form-group\">
                                        ";
        // line 105
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["country"], "method", false, false, false, 105), "html", null, true);
        echo "
                                        <select name=\"codpais\" class=\"form-control\">
                                            <option value=\"\">";
        // line 107
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["all"], "method", false, false, false, 107), "html", null, true);
        echo "</option>
                                            <option value=\"\">------</option>
                                            ";
        // line 109
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "pais", [], "any", false, false, false, 109), "all", [[], ["nombre" => "ASC"], 0, 0], "method", false, false, false, 109));
        foreach ($context['_seq'] as $context["_key"] => $context["pais"]) {
            // line 110
            echo "                                                ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["pais"], "codpais", [], "any", false, false, false, 110), twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "codpais", [], "any", false, false, false, 110)))) {
                // line 111
                echo "                                                    <option value=\"";
        ...
        echo "                                        </select>
                                ...
                                <div class=\"col-sm-3\">
                                    <div class=\"form-group\">
                                        ";
        // line 122
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["format"], "method", false, false, false, 122), "html", null, true);
        echo "
                                ...
                                <div class=\"col-sm\">
                                    <div class=\"form-group\">
                                        <button type=\"submit\" class=\"btn btn-primary\">
                                            ";
        // line 133
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["generate"], "method", false, false, false, 133), "html", null, true);
        echo "
                                        </button>
                                    </div>
                                </div>
...
{% endblock %}", "ReportTaxes.html.twig", "C:\\xampp\\htdocs\\public\\Core\\View\\ReportTaxes.html.twig");
    }
}
