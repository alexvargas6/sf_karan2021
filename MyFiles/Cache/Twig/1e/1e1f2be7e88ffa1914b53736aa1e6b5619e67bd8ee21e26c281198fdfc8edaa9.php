...
class __TwigTemplate_30fa4b103379b9995b403e34ae77feb53ebad369b7fcd3313d572d135064efca extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["viewName"] => $context["view"]) {
            ...
            if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["view"], "count", [], "any", false, false, false, 104), 0))) {
                ...
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "toolBox", [], "method", false, false, false, 105), "numbers", [], "method", false, false, false, 105), "format", [twig_get_attribute($this->env, $this->source, $context["view"], "count", [], "any", false, false, false, 105), 0], "method", false, false, false, 105), "html", null, true);
                echo "</span>
                    ";
            }
            // line 107
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["viewName"] => $context["view"]) {
            ...
            echo "\" role=\"tabpanel\">
                ";
            // line 120
            twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "setCurrentView", [$context["viewName"]], "method", false, false, false, 120);
            // line 121
            echo "                ";
...
{% block bodyHeaderOptions %}
    ...
    <div class=\"container-fluid mb-3 d-print-none\">
        <div class=\"row\">
                ...
                {% if firstView.settings.btnOptions %}
                    <div class=\"btn-group\">
                        <div class=\"dropdown\">
                            <button class=\"btn btn-sm btn-secondary dropdown-toggle\" type=\"button\"
                                    data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">
                                <i class=\"fas fa-wrench fa-fw\" aria-hidden=\"true\"></i> {{ trans('options') }}
                            </button>
                            <div class=\"dropdown-menu\">
            ...
            <div class=\"col-md-5 text-right\">
                <h1 class=\"h4 mb-0 d-none d-md-inline-block\">
                    {{ fsc.title }}<i class=\"{{ pageData.icon }} ml-3\" aria-hidden=\"true\"></i>
                </h1>
            </div>
        </div>
    </div>
...
{% endblock %}", "Master/ListController.html.twig", "C:\\xampp\\htdocs\\sistema2\\Core\\View\\Master\\ListController.html.twig");
    }
}
