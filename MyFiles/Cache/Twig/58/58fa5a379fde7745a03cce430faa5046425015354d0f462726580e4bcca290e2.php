...
class __TwigTemplate_7f22dbd3c4440aa41b7aad9f70c9b502dec56f96ded5fb56befa027d50a48d3f extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\">
        ...
        echo "\">
                            ";
        // line 11
        $context["idfile"] = twig_get_attribute($this->env, $this->source, ($context["appSettings"] ?? null), "get", ["default", "idloginimage", 0], "method", false, false, false, 11);
        // line 12
        echo "                            ";
        ...
        try {
            ...
            if ((1 === twig_compare(($context["idfile"] ?? null), 0))) {
                ...
                if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["attached"] ?? null), "filename", [], "any", false, false, false, 156))) {
                    // line 157
                    echo "            ";
                    $context["url"] = twig_get_attribute($this->env, $this->source, ($context["attached"] ?? null), "url", ["download-permanent"], "method", false, false, false, 157);
                    // line 158
                    echo "        ";
                }
                // line 159
...
{% endmacro loadLogo %}", "Login/Login.html.twig", "C:\\xampp\\htdocs\\sistema2\\Core\\View\\Login\\Login.html.twig");
    }
}
