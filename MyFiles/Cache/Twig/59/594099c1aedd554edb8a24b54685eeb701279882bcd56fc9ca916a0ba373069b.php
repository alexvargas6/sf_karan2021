...
class __TwigTemplate_b5c2f29419e307444d079bcb9f98129e754f843fcc55fb169a3caaddf3f841e3 extends Template
{
    private $source;
    private $macros = [];
        ...
        <form action=\"{{ fsc.url() }}\" name=\"upload-plugins\" method=\"post\" class=\"form\" enctype=\"multipart/form-data\">
            ...
            <div class=\"modal fade\" id=\"modalAddPlugin\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\">
                <div class=\"modal-dialog\" role=\"document\">
                    <div class=\"modal-content\">
                        <div class=\"modal-header\">
                            <h5 class=\"modal-title\">{{ trans('add-new-plugin') }}</h5>
                            <button type=\"button\" class=\"close\" data-dismiss=\"modal\"
...
{% endmacro %}", "AdminPlugins.html.twig", "C:\\xampp\\htdocs\\sistema2\\Core\\View\\AdminPlugins.html.twig");
    }
}
