...
/* Dashboard.html.twig */
class __TwigTemplate_8c08b251952083a62a7dccddfb76535cc2877e02d9f83266a476734100d68d17 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card shadow mb-3\">
        <div class=\"pl-3 pt-1 pr-3 pb-3\">
            <div class=\"form-row\">
                <div class=\"col-md\">
                    <h2 class=\"h4 mt-3 mb-1\">
                        <i class=\"fas fa-plus fa-fw\"></i> {{ trans('create') }}
                    </h2>
                    <ul class=\"mb-1\">
                ...
                {% if fsc.openLinks %}
                    <div class=\"col-md\">
                        <h2 class=\"h4 mt-3 mb-1\">
                            <i class=\"fas fa-folder-open fa-fw\"></i> {{ trans('open') }}
                        </h2>
                        <ul class=\"mb-1\">
                ...
                <div class=\"col-md\">
                    <h2 class=\"h4 mt-3 mb-1\">
                        <i class=\"fas fa-question-circle fa-fw\"></i> {{ trans('help') }}
                    </h2>
                    <ul class=\"mb-1\">
                        <li>
                            <a href=\"https://facturascripts.com/publicaciones/configuracion-15\" rel=\"nofollow\"
...
{% macro sectionLowStock(fsc) %}
    <div class=\"card shadow mb-3\">
        <div class=\"p-3\">
            <h2 class=\"h4 mb-0\">
                <i class=\"fas fa-pallet fa-fw\"></i> {{ trans('minimum-stock') }}
            </h2>
        </div>
        <div class=\"table-responsive\">
            <table class=\"table table-sm table-hover mb-0\">
                ...
                <tr>
                    ...
                    <th class=\"text-right\">{{ trans('minimum-stock') }}</th>
                    <th class=\"text-right\">{{ trans('available') }}</th>
                </tr>
                </thead>
                <tbody>
                {% for stock in fsc.lowStock %}
                    <tr class=\"clickableRow table-danger\" data-href=\"{{ stock.url() }}\">
                        ...
                        <td class=\"text-right\">{{ number(stock.stockmin) }}</td>
                        <td class=\"text-right\">{{ number(stock.disponible) }}</td>
                    </tr>
                {% endfor %}
                </tbody>
            </table>
...
{% endmacro %}", "Dashboard.html.twig", "C:\\xampp\\htdocs\\public\\Core\\View\\Dashboard.html.twig");
    }
}
