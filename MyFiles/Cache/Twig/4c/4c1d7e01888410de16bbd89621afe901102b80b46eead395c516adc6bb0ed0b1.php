...
class __TwigTemplate_11c735757489b1c935e3aac84deb977c4e0093d85f8898b9e188f2a1af55dbcc extends Template
{
    private $source;
    private $macros = [];
...
<form id=\"";
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "totalAmounts", [], "any", false, false, false, 185))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                echo "                            <td class=\"text-right\">
                                ";
                // line 203
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "toolBox", [], "method", false, false, false, 203), "numbers", [], "method", false, false, false, 203), "format", [twig_get_attribute($this->env, $this->source, $context["item"], "page", [], "any", false, false, false, 203)], "method", false, false, false, 203), "html", null, true);
                echo "
                            </td>
                        ";
            }
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                echo "                            <td class=\"text-right\">
                                ";
                // line 211
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "toolBox", [], "method", false, false, false, 211), "numbers", [], "method", false, false, false, 211), "format", [twig_get_attribute($this->env, $this->source, $context["item"], "total", [], "any", false, false, false, 211)], "method", false, false, false, 211), "html", null, true);
                echo "
                            </td>
                        ";
            }
    ...
    ";
        ...
        <div class=\"row\">
            ";
        // line 238
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "getRow", ["footer"], "method", false, false, false, 238), "render", [twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "getViewName", [], "method", false, false, false, 238), "listViewSetAction", ($context["fsc"] ?? null)], "method", false, false, false, 238);
        echo "
        </div>
    </div>
    ";
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            // line 249
            echo "    ";
            echo twig_get_attribute($this->env, $this->source, $context["group"], "modal", [twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "model", [], "any", false, false, false, 249), twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "getViewName", [], "method", false, false, false, 249)], "method", false, false, false, 249);
            echo "
";
        }
        $_parent = $context['_parent'];
...
";
    ...
    public function macro_colorsButton($__currentView__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 344
            echo "    ";
            $context["legend"] = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "getRow", ["status"], "method", false, false, false, 344), "legend", [], "method", false, false, false, 344);
            // line 345
            echo "    ";
...
{% macro sortButton(currentView) %}
    ...
    {% endif %}
{% endmacro %}
", "Master/ListView.html.twig", "C:\\xampp\\htdocs\\sistema2\\Core\\View\\Master\\ListView.html.twig");
    }
}
